...
class User(UserMixin, db.Model):
    ...
    submissions = db.relationship(
        "AnswerSubmission", backref="user", lazy=True, cascade="all, delete-orphan"
    )
    articles = db.relationship(
        "Article", backref="author", lazy="dynamic", cascade="all, save-update"
    )
...
class AnswerSubmission(db.Model):
    ...
    answer_box_id = db.Column(
        db.Integer, db.ForeignKey("challenge_answer_box.id"), nullable=False
    )
